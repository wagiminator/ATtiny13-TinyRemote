...
// avrdude -p attiny13 -c usbasp -F -U lfuse:w:0x6a:m -U hfuse:w:0xfe:m
//
...
#define startPulse    {IRon; _delay_ms(9); _delay_us(100); IRoff;}
#define normalPulse   {IRon; _delay_us(650); IRoff;}
#define bit0Pause     _delay_us(450)
#define bit1Pause     _delay_us(1600)
#define startPause    _delay_us(4400)
#define repeatPause   _delay_us(2200)
